...
function dioramaScene(kind, zoom = 1) {
  return (ctx) => {
    ...
    if (kind === "embodied") {
      ...
      const mSky = rMat(0xaedcf5, { emissive: 0x8ec8ee, emissiveIntensity: 0.5, roughness: 0.5 });
      const windowG = new THREE.Group(); windowG.position.set(0.95, 0.82, -RD + 0.05); home.add(windowG);
