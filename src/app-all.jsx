    ...
    <div className="mountain-landscape" aria-hidden="true">
      <svg className="mountain-svg" viewBox="0 0 1440 420" preserveAspectRatio="xMidYMax slice" focusable="false">
        ...
        <g className="ridge mid" filter="url(#mountainShadow)">
          <path d="M0 350 122 236 224 288 340 132 468 334 590 214 718 340 846 122 972 330 1080 224 1192 344 1322 180 1440 292V420H0Z" fill="url(#midRidge)" />
          <polygon points="340,132 468,334 382,274" fill="url(#facetShadow)" />
          <polygon points="340,132 255,288 382,274" fill="url(#facetLight)" />
          <polygon points="846,122 972,330 890,276" fill="url(#facetShadow)" />
        ...
        <g className="ridge front" filter="url(#mountainShadow)">
          <path d="M0 378 108 304 214 342 332 240 460 368 600 268 742 376 892 250 1024 372 1158 282 1286 374 1440 284V420H0Z" fill="url(#frontRidge)" />
          <polygon points="332,240 460,368 379,326" fill="url(#facetShadow)" />
          <polygon points="332,240 214,342 379,326" fill="url(#facetLight)" />
